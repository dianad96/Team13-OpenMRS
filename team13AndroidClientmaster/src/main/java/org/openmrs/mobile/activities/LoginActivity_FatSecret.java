...
public class LoginActivity_FatSecret extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!accessToken.equals(ACCESS_TOKEN_MISSING)) {
            Intent home = new Intent(this, SearchFood.class);
            startActivity(home);
            finish();
            return;
        }

        setContentView(R.layout.activity_login_activity__fat_secret);
                        ...
                        public void onPageFinished(WebView view, String url) {
                            ...
                            if (url.contains("postVerify")) {
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        final ProgressDialog progressDialog = new ProgressDialog(LoginActivity_FatSecret.this);
                                        ...
                                        new Thread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                try {
                                                    ...
                                                    Intent home = new Intent(LoginActivity_FatSecret.this, SearchFood.class);
                                                    startActivity(home);
                                                    finish();
